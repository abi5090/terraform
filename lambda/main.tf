...
module "backup_lambda" {
   ...
   filename            = "${path.module}../code/${var.environment}/${var.environment}_backup_lambda_function.zip"
   handler             = "${var.environment}_backup_lambda_function.lambda_handler"
...
module "cleanup_lambda" {
   ...
   filename            = "${path.module}../code/${var.environment}/${var.environment}_cleanup_lambda_function.zip"
   handler             = "${var.environment}_cleanup_lambda_function.lambda_handler"
   role_arn            = "${module.lambda_role.role_arn}"
   trigger_service     = "events.amazonaws.com"
